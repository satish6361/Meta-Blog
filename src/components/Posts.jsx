  ...
  if (filteredPosts.length === 0) {
    return (
      <div className="w-full py-5 ">
        ...
        <br />
        <div className="text-2xl min-h-80 flex justify-center items-center text-white">
        ...
        <div className="flex flex-wrap gap-2 gap-y-4 duration-500 justify-center">
          {filteredPosts
            ...
            .map((post) => (
              <div
                key={post.$id}
                className="p-4 sm:p-2 w-full duration-200 cursor-pointer hover:border-gray-300 rounded-md min-w-64 sm:w-72 md:w-1/2 lg:w-1/4"
              >
                <PostCard {...post} />
              </div>
            ))}
